    ...
    const Vec2d position, bool with_reset)
{
    ...
    m_axes.set_origin({10.0, 10.0, static_cast<double>(GROUND_Z) });
    m_axes.set_stem_length(0.1f * static_cast<float>(m_build_volume.bounding_volume().max_size())); //eksen göstergesi
