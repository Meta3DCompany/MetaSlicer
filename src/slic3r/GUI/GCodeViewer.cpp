                ...
                const std::vector<BoundingBoxf3>& exclude_bounding_box, ConfigOptionMode mode, bool only_gcode)
{
    ...
    std::cout <<"i am here gcodeviewer"<<endl;
        ...
        std::function<void()> callback = nullptr)
    {
        ...
        if (callback) {
            ...
            if (checkbox) {
                ...
                ImGui::PushStyleColor(ImGuiCol_CheckMark, ImVec4(1.0f, 0.68f, 0.00f, 1.00f));
...
void GCodeViewer::push_combo_style()
{
    ...
    ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(1.0f, 0.68f, 0.00f, 1.00f));
    ImGui::PushStyleColor(ImGuiCol_HeaderHovered, ImVec4(1.0f, 0.68f, 0.00f, 0.0f));
