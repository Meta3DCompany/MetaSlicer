...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Hovered),
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(255, 174, 0 ), StateColor::Normal));
