...
MachineObjectPanel::MachineObjectPanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name)
{
    ...
    SetBackgroundColour(StateColor::darkModeColorFor(*wxWHITE)); //Meta3D: Machines configuration panel
    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Hovered),
    ...
    : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Modifying the device name"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(255, 174, 0  ), StateColor::Pressed), std::pair<wxColour, int>(wxColour(255, 174, 0 ), StateColor::Normal));
