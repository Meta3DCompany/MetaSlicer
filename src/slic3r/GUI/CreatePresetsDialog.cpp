...
//Meta3D: Note to self: add Meta3D Here!
static const std::vector<std::string> printer_vendors = {"Meta3D","Anycubic",  "Artillery", "BIBO",           "BIQU",     "Creality ENDER", "Creality CR", "Creality SERMOON",
...
wxBoxSizer *CreateFilamentPresetDialog::create_button_item()
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(44, 96, 34 ), StateColor::Pressed), std::pair<wxColour, int>(wxColour(44, 96, 34 ), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(44, 96, 34), StateColor::Normal));
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(44, 96, 34), StateColor::Pressed), std::pair<wxColour, int>(wxColour(44, 96, 34), StateColor::Hovered),
